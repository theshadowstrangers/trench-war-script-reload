...
dashBtn.Size = UDim2.new(1, 0, 0, 32)
dashBtn.Text = "Dash No-cooldown OFF"
dashBtn.TextColor3 = Color3.fromRGB(255, 85, 85)
dashBtn.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
dashBtn.Font = Enum.Font.SourceSansBold
dashBtn.TextSize = 13
dashBtn.BorderSizePixel = 0
dashBtn.Parent = playerTab
Instance.new("UICorner", dashBtn).CornerRadius = UDim.new(0, 4)
...
dashBtn.MouseButton1Click:Connect(function()
    cOn = not cOn
    dashBtn.Text = cOn and "Dash No-cooldown ON" or "Dash No-cooldown OFF"
    dashBtn.BackgroundColor3 = cOn and Color3.fromRGB(85, 255, 85) or Color3.fromRGB(60, 60, 60)
    dashBtn.TextColor3 = cOn and Color3.fromRGB(0, 0, 0) or Color3.fromRGB(255, 85, 85)
end)
