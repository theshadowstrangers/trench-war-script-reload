...
tp50Btn.MouseButton1Click:Connect(function()
    local hrp = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
    if hrp then
        hrp.CFrame = CFrame.new(1065.55481, 2120.09448, 33367.0312, -0.404229909, -1.2033799e-10, -0.914657414, -5.62539959e-10, 1, 1.17046539e-10, 0.914657414, 5.6184507e-10, -0.404229909)
    end
end)
